"""Distill EuroBERT-2.1B block classifier into EuroBERT-210m via all-position KL-div.
...
STUDENT_MODEL = "EuroBERT/EuroBERT-210m"
MAX_TOKENS = 8192
SEED = 42
ALPHA = 0.7
TEMPERATURE = 2.0
...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, 'block_classifier_eurobert_210m_distill')
...
def main():
    ...
    if is_main:
        print(f'=== EuroBERT Distillation: 2.1B → 210m (Phase 2: Train) ===', flush=True)
